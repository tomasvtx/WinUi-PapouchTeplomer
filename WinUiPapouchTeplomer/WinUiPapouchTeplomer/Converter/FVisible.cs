...
{
    public class FVisible : IValueConverter
    {
        ...
        /// <returns>Collapsed, pokud je vstupní řetězec "Celsius"; jinak Visible.</returns>
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            if (value is string floatValue)
            {
                return floatValue == "Celsius" ? Visibility.Collapsed : Visibility.Visible;
            }
